...
function AIHomeworkHelperPage() {
  ...
  return (
    <div className="container mx-auto p-8 pt-24 min-h-screen bg-gradient-to-br from-gray-50 to-blue-50"> {/* Adjusted pt-24, added subtle gradient background */}
      <div className="flex justify-start mb-8"> {/* Increased bottom margin */}
        <button
      ...
      <h1 className="text-4xl font-extrabold text-blue-800 mb-4 text-center">AI Homework Helper</h1> {/* Larger, bolder, blue heading */}
      <p className="text-xl text-gray-700 mb-10 text-center max-w-2xl mx-auto"> {/* Larger, darker gray text, centered */}
        Enter your math or science problem below, and get a step-by-step explanation.
      </p>

      <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl shadow-xl mb-8 border border-blue-100"> {/* Increased padding, rounded corners, shadow, border */}
        <div className="mb-6">
          <label htmlFor="problemInput" className="block text-lg font-semibold text-gray-800 mb-3"> {/* Bolder label */}
            Your Problem:
          </label>
          <textarea
            id="problemInput"
